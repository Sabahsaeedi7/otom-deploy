...
import 'create_accountby_phone_model.dart';
export 'create_accountby_phone_model.dart';

class CreateAccountbyPhoneWidget extends StatefulWidget {
  const CreateAccountbyPhoneWidget({Key? key}) : super(key: key);

  @override
  _CreateAccountbyPhoneWidgetState createState() =>
      _CreateAccountbyPhoneWidgetState();
}

class _CreateAccountbyPhoneWidgetState extends State<CreateAccountbyPhoneWidget>
    with TickerProviderStateMixin {
  late CreateAccountbyPhoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountbyPhoneModel());
