...
import 'gold_edit_model.dart';
export 'gold_edit_model.dart';

class GoldEditWidget extends StatefulWidget {
  const GoldEditWidget({
    Key? key,
  ...
  @override
  _GoldEditWidgetState createState() => _GoldEditWidgetState();
}

class _GoldEditWidgetState extends State<GoldEditWidget> {
  late GoldEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GoldEditModel());
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await widget.carIdforPlanEdit!
                                    ...
                                    plan: 'GOLD',
                                    expiredDate: functions.calculateTargetDate(
