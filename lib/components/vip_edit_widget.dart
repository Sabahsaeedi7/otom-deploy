...
import 'vip_edit_model.dart';
export 'vip_edit_model.dart';

class VipEditWidget extends StatefulWidget {
  const VipEditWidget({
    Key? key,
  ...
  @override
  _VipEditWidgetState createState() => _VipEditWidgetState();
}

class _VipEditWidgetState extends State<VipEditWidget> {
  late VipEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VipEditModel());
