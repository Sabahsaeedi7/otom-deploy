...
import 'vip_plan_model.dart';
export 'vip_plan_model.dart';

class VipPlanWidget extends StatefulWidget {
  const VipPlanWidget({Key? key}) : super(key: key);

  @override
  _VipPlanWidgetState createState() => _VipPlanWidgetState();
}

class _VipPlanWidgetState extends State<VipPlanWidget> {
  late VipPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VipPlanModel());
                  ...
                  child: Container(
                    ...
                    child: Align(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'بەرێزت پلانی وی ئایپەت هەلبژاردوە',
